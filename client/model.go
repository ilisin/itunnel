...
const (
	defaultServerAddr   = "itunneld.itunnel.com:443"
...
func (c *ClientModel) control() {
	...
	if c.proxyUrl == "" {
		...
		ctlConn, err = conn.DialHttpProxy(c.proxyUrl, c.serverAddr, "ctl", nil)
	}
	if err != nil {
		panic(err)
	}
...
// Hearbeating to ensure our connection itunneld is still live
